...
```{=html}
<!-- Replace VIDEO_ID with your YouTube video ID, or use a local file -->
<!-- YouTube example: -->
...
<!-- <video controls width="100%">
  <source src="../videos/2026-01-13.mp4" type="video/mp4">
</video> -->
<p><em>Video placeholder — add YouTube URL or local .mp4 file</em></p>
```
